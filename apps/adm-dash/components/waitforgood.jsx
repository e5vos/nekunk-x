...
export default function WaitForGoodUser() {
  ...
  return (
    <>
      <Top name="Hibás felhasználó"></Top>
      ...
      <Flex
        ...
        pb={"10vh"}
      >
        <Heading>Helló, {user.firstName}</Heading>
        ...
        >
          ...
          >
            ...
            <Text>
              Amennyiben tényleg nem vagy adminisztrátor, kérlek töröld fiókod!
            </Text>
          </Flex>
        </Box>
        <Box
        ...
        >
          ...
          >
            <Text>
              Jelenleg nagy eséllyel nem keresünk csapattagokat, viszont lelkes
              segítőkre bármikor szükség lehet.
            </Text>
